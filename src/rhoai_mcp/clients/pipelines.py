...
class PipelineClient:
    ...
    def create_pipeline_server(
        self, request: PipelineServerCreate
    ) -> PipelineServer:
        """Create a pipeline server (DSPA)."""
        body = self._build_dspa_cr(request)
        dspa = self._k8s.create(CRDs.DSPA, body=body, namespace=request.namespace)
