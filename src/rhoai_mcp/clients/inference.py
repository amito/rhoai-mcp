...
from rhoai_mcp.models.inference import (
    InferenceService,
...
class InferenceClient:
    ...
    def list_inference_services(self, namespace: str) -> list[dict[str, Any]]:
        ...
        try:
            isvc_list = self._k8s.list(CRDs.INFERENCE_SERVICE, namespace=namespace)
        except Exception:
            return []
    ...
    def get_inference_service(
        ...
        isvc = self._k8s.get(CRDs.INFERENCE_SERVICE, name=name, namespace=namespace)
    ...
    def _build_inference_service_cr(
        self, request: InferenceServiceCreate
    ) -> dict[str, Any]:
        ...
        return {
            "apiVersion": CRDs.INFERENCE_SERVICE.api_version,
            "kind": CRDs.INFERENCE_SERVICE.kind,
            "metadata": {
                "name": request.name,
