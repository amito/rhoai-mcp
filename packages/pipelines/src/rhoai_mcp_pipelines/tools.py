...
from rhoai_mcp_pipelines.client import PipelineClient
from rhoai_mcp_pipelines.models import PipelineServerCreate
...
def register_tools(mcp: FastMCP, server: "RHOAIServer") -> None:
    ...
    def create_pipeline_server(
        ...
        return {
            ...
            "message": (
                "Pipeline server created. It may take several minutes to become ready."
            ),
        }
