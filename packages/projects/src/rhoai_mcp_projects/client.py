...
from rhoai_mcp_projects.models import DataScienceProject, ProjectCreate
...
class ProjectClient:
    ...
    def _get_resource_summary(self, namespace: str) -> ResourceSummary:
        ...
        # Import here to avoid circular imports when other plugins not available
        workbenches = 0
        ...
        # Count workbenches (try to import notebooks plugin CRDs)
        try:
        ...
        # Count models (try to import inference plugin CRDs)
        try:
